//! Fixture loader, comparator, scoring and report for checking `irosashi` against
...
use irosashi::{CodeToTokensOptions, Highlighter, HighlighterBuilder};
...
/// Path of the `irosashi` crate's `assets/` directory.
pub fn assets_dir() -> PathBuf {
    Path::new(env!("CARGO_MANIFEST_DIR")).join("../irosashi/assets")
}
...
pub fn actual_tokens(
    ...
    fixture: &Fixture,
    theme_name: &str,
) -> Result<Vec<Vec<FixtureToken>>, irosashi::Error> {
